...
namespace WidgetShowcase
{
    public class ArmHUDMGR : MonoBehaviour
    {
        ...
        void Update()
        {
            StatusPanelTimeText.text = System.DateTime.UtcNow.ToString("hh:mm") + " GMT";
            StatusPanelDateTimeText.text = System.DateTime.UtcNow.DayOfWeek.ToString() + " " + System.DateTime.UtcNow.ToString("MM dd yyyy");
        ...
        void AlignArmHUD(CapsuleHand hand)
        {
            ...
            if (targetHandID != hand.GetInstanceID())
            {
                ...
                Vector3 localArmCenter = UnityVectorExtension.ToVector3(hand.GetLeapHand().Arm.Center);
